                    ...
                    <div class="container-fluid">
                        <div class="nk-header-wrap">
                            ...
                            <div class="nk-header-brand d-xl-none"><a href="../index.html" class="logo-link"><img
                                        class="logo-light logo-img" src="../../assets/images/logo.png"
                                        srcset="/demo2/images/logo2x.png 2x" alt="logo"/><img class="logo-dark logo-img"
                                        src="../../assets/images/logo-dark.png" srcset="/demo2/images/logo-dark2x.png 2x"
                                        alt="logo-dark"/></a></div>
                                ...
                                <ul class="nk-quick-nav">
                                    <li class="dropdown language-dropdown d-none d-sm-block me-n1"><a href="#"
                                            ...
                                            <div class="quick-icon border border-light"><img class="icon"
                                                    src="../../assets/images/flags/english-sq.png" alt=""/></div>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-s1">
                                            <ul class="language-list">
                                                <li><a href="#" class="language-item"><img
                                                            src="../../assets/images/flags/english.png" alt=""
                                                            class="language-flag"/><span
                                                            class="language-name">English</span></a></li>
                                                <li><a href="#" class="language-item"><img
                                                            src="../../assets/images/flags/spanish.png" alt=""
                                                            class="language-flag"/><span
                                                            class="language-name">Español</span></a></li>
                                                <li><a href="#" class="language-item"><img
                                                            src="../../assets/images/flags/french.png" alt=""
                                                            class="language-flag"/><span
                                                            class="language-name">Français</span></a></li>
                                                <li><a href="#" class="language-item"><img
                                                            src="../../assets/images/flags/turkey.png" alt=""
                                                            class="language-flag"/><span
                                    ...
                                    <li class="dropdown chats-dropdown hide-mb-xs"><a href="#"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                            ...
                                            <div class="dropdown-body">
                                                <ul class="chat-list">
                                                    <li class="chat-item"><a class="chat-link" href="message.html">
                                                    ...
                                                    <li class="chat-item"><a class="chat-link" href="message.html">
                                                            <div class="chat-media user-avatar"><img
                                                                    src="../../assets/images/avatar/b-sm.jpg" alt=""/></div>
                                                            <div class="chat-info">
                                                                <div class="chat-from">
                                                    ...
                                                    <li class="chat-item"><a class="chat-link" href="message.html">
                                                            <div class="chat-media user-avatar user-avatar-multiple">
                                                                <div class="user-avatar"><img
                                                                        src="../../assets/images/avatar/c-sm.jpg" alt=""/></div>
                                                    ...
                                                    <li class="chat-item"><a class="chat-link" href="message.html">
                                                            <div class="chat-media user-avatar"><img
                                                                    src="../../assets/images/avatar/a-sm.jpg" alt=""/><span
                                                                    class="status dot dot-lg dot-success"></span></div>
                                                            <div class="chat-info">
                                                                <div class="chat-from">

                                                ...
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb"><span
                                                                class="sub-text d-lg-flex d-none">Enrolled
                                                                Courses</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span
                                                                class="sub-text">Phone</span></div>
                                                        <div class="nk-tb-col tb-col-lg"><span
                                                                class="sub-text">Country</span></div>
                                                        <div class="nk-tb-col tb-col-lg"><span
                                                                class="sub-text">Payment</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col"><Link to="/details">
                                                                <div class="user-card">

                                            ...
                                            <table class="nk-tb-list nk-tb-ulist">
                                                ...
                                                <tbody>
                                                    <tr class="nk-tb-item">
                                                        <td class="nk-tb-col nk-tb-col-check">
                                                            <div
                                                                ...
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    for="pid-01"></label></div>
                                                        </td>
                                                        <td class="nk-tb-col"><a href="apps-kanban.html"
                                                                class="project-title">
                                                                <div class="user-avatar sq"><span>DD</span>
                                                                </div>
                                                                <div class="project-info">
                                                                    <h6 class="title">Dashlite Development</h6>
                                                                </div>
                                                            </a></td>
                                                        <td class="nk-tb-col tb-col-xxl"><span>Softnio</span></td>
                                                        <td class="nk-tb-col tb-col-xxl"><span>Abu Bin Istiak</span>
                                                        </td>
                                                        ...
                                                        <td class="nk-tb-col tb-col-xxl"><span>Open</span></td>
                                                        <td class="nk-tb-col tb-col-md">
                                                            <div class="project-list-progress">
                                                                <div
                                                                    class="progress progress-pill progress-md bg-light">
                                                                    <div class="progress-bar" data-progress="93.5">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <td class="nk-tb-col tb-col-mb"><span
                                                                class="badge badge-dim bg-warning"><em
                                                    ...
                                                    <tr class="nk-tb-item">
                                                        <td class="nk-tb-col nk-tb-col-check">
                                                            <div
                                                                class="custom-control custom-control-sm custom-checkbox notext">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    id="pid-02"/><label class="custom-control-label"
                                                                    for="pid-02"></label></div>
                                                        </td>
                                                        <td class="nk-tb-col"><a href="apps-kanban.html"
                                                                class="project-title">
                                                                <div class="user-avatar sq bg-warning"><span>RW</span>
                                                                </div>
                                                                <div class="project-info">
                                                                    <h6 class="title">Redesign Website</h6>
                                                                </div>
                                                            </a></td>
                                                        <td class="nk-tb-col tb-col-xxl"><span>Runnergy</span></td>
                                                        <td class="nk-tb-col tb-col-xxl"><span>Alex Ashley</span></td>
                                                        <td class="nk-tb-col tb-col-lg">
                                                            <ul class="project-users g-1">
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <div class="user-avatar sm bg-blue"><span>N</span>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                        <td class="nk-tb-col tb-col-xxl"><span>Onhold</span></td>
                                                        <td class="nk-tb-col tb-col-md">
                                                            <div class="project-list-progress">
                                                                <div
                                                                    class="progress progress-pill progress-md bg-light">
                                                        ...
                                                        <td class="nk-tb-col tb-col-mb"><span
                                                                class="badge badge-dim bg-light text-gray"><em
                                                    ...
                                                    <tr class="nk-tb-item">
                                                        <td class="nk-tb-col nk-tb-col-check">
                                                            <div
                                                                class="custom-control custom-control-sm custom-checkbox notext">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    id="pid-03"/><label class="custom-control-label"
                                                                    for="pid-03"></label></div>
                                                        </td>
                                                        <td class="nk-tb-col"><a href="apps-kanban.html"
                                                                class="project-title">
                                                                <div class="user-avatar sq bg-info"><span>KR</span>
                                                                </div>
                                                                <div class="project-info">
                                                                    <h6 class="title">Keyword Research for SEO</h6>
                                                                </div>
                                                            </a></td>
                                                        <td class="nk-tb-col tb-col-xxl"><span>Techyspec</span></td>
                                                        <td class="nk-tb-col tb-col-xxl"><span>Emily Smith</span></td>
                                                        <td class="nk-tb-col tb-col-lg">
                                                            <ul class="project-users g-1">
                                                                <li>
                                                                    <div class="user-avatar sm bg-primary"><img
                                                        ...
                                                        <td class="nk-tb-col tb-col-xxl"><span>Ongoing</span></td>
                                                        <td class="nk-tb-col tb-col-md">
                                                            <div class="project-list-progress">
                                                                <div
                                                                    class="progress progress-pill progress-md bg-light">
                                                                    <div class="progress-bar" data-progress="52.5">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <td class="nk-tb-col tb-col-mb"><span
                                                                class="badge badge-dim bg-danger"><em
                                                                    class="icon ni ni-clock"></em><span>Due
                                                                    Tomorrow</span></span></td>
                                                        <td class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li>
                                                                    <div class="drodown"><a href="#"
                                                    ...
                                                    <tr class="nk-tb-item">
                                                        <td class="nk-tb-col nk-tb-col-check">
                                                            <div
                                                                class="custom-control custom-control-sm custom-checkbox notext">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    id="pid-04"/><label class="custom-control-label"
                                                                    for="pid-04"></label></div>
                                                        </td>
                                                        <td class="nk-tb-col"><a href="apps-kanban.html"
                                                                class="project-title">
                                                                <div class="user-avatar sq bg-danger"><span>WD</span>
                                                                </div>
                                                                <div class="project-info">
                                                                    <h6 class="title">Website Development</h6>
                                                                </div>
                                                            </a></td>
                                                        <td class="nk-tb-col tb-col-xxl"><span>Fitness Next</span></td>
                                                        <td class="nk-tb-col tb-col-xxl"><span>Michael Wood</span></td>
                                                        <td class="nk-tb-col tb-col-lg">
                                                            <ul class="project-users g-1">
                                                                <li>
                                                                    <div class="user-avatar sm bg-blue"><span>N</span>
                                                    ...
                                                    <tr class="nk-tb-item">
                                                        <td class="nk-tb-col nk-tb-col-check">
                                                            <div
                                                                class="custom-control custom-control-sm custom-checkbox notext">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    id="pid-05"/><label class="custom-control-label"
                                                                    for="pid-05"></label></div>
                                                        </td>
                                                        <td class="nk-tb-col"><a href="apps-kanban.html"
                                                                class="project-title">
                                                                <div class="user-avatar sq bg-blue"><span>SO</span>
                                                                </div>
                                                                <div class="project-info">
                                                        ...
                                                        <td class="nk-tb-col tb-col-xxl"><span>Closed</span></td>
                                                        <td class="nk-tb-col tb-col-md">
                                                            <div class="project-list-progress">
                                                                <div
                                                                    class="progress progress-pill progress-md bg-light">
                                                        ...
                                                        <td class="nk-tb-col tb-col-mb"><span
                                                                class="badge badge-dim bg-success"><em
                                                    ...
                                                    <tr class="nk-tb-item">
                                                        <td class="nk-tb-col nk-tb-col-check">
                                                            <div
                                                                class="custom-control custom-control-sm custom-checkbox notext">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    id="pid-07"/><label class="custom-control-label"
                                                                    for="pid-07"></label></div>
                                                        </td>
                                                        <td class="nk-tb-col"><a href="apps-kanban.html"
                                                                class="project-title">
                                                                <div class="user-avatar sq bg-danger"><span>WD</span>
                                                    ...
                                                    <tr class="nk-tb-item">
                                                        <td class="nk-tb-col nk-tb-col-check">
                                                            <div
                                                                class="custom-control custom-control-sm custom-checkbox notext">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    id="pid-08"/><label class="custom-control-label"
                                                                    for="pid-08"></label></div>
                                                        </td>
                                                        <td class="nk-tb-col"><a href="apps-kanban.html"
                                                                class="project-title">
                                                                <div class="user-avatar sq bg-warning"><span>RW</span>
                                                        ...
                                                        <td class="nk-tb-col tb-col-lg">
                                                            <ul class="project-users g-1">
                                                                <li>
                                                                    <div class="user-avatar sm bg-pink"><span>I</span>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="user-avatar sm bg-primary"><img

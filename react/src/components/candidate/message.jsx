                                    ...
                                    <div class="nk-chat-aside-body" data-simplebar>
                                        ...
                                        <div class="nk-chat-aside-panel nk-chat-fav">
                                            ...
                                            <ul class="fav-list">
                                                ...
                                                <li><a to="#">
                                                        <div class="user-avatar-2"><span>LH</span><img src="images/avatar/b-sm.jpg"
                                                                alt=""/><span
                                                ...
                                                <li><a to="#">
                                                        <div class="user-avatar-2"><span>LH</span><img src="images/avatar/a-sm.jpg"
                                                                alt=""/><span
                                                                class="status dot dot-lg dot-success"></span></div>
                                                    </a></li>
                                                <li><a to="#">
                                                        <div class="user-avatar-2"><span>Hk</span><img src="images/avatar/c-sm.jpg"
                                                                alt=""/><span
                                                                class="status dot dot-lg dot-success"></span></div>
                                                    </a></li>
                                                <li><a to="#">
                                                        <div class="user-avatar-2"><span>LN</span><img src="images/avatar/d-sm.jpg"
                                                                alt=""/><span
                                                                class="status dot dot-lg dot-success"></span></div>
                                                    </a></li>
                                                <li><a to="#">
                                        ...
                                        <div class="nk-chat-list">
                                            ...
                                            <ul class="chat-list">
                                                ...
                                                <li class="chat-item is-unread"><a class="chat-link chat-open" to="#">
                                                        <div class="chat-media user-avatar-2"><span>AB</span><span
                                                                class="status dot dot-lg dot-gray"></span></div>
                                                        <div class="chat-info">
                                                            <div class="chat-from">
                                                ...
                                                <li class="chat-item"><a class="chat-link chat-open" to="#">
                                                        <div class="chat-media user-avatar-2"><span>KL</span><img

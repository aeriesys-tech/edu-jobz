  ...
  (p.ClassBody = function () {
    ...
    (p.Copied = function () {
      ...
      function t(e, t) {
        var e = x(e),
          ...
          e =
            ((a.text = e.text || a.text),
            (a.done = e.done || a.done),
            (a.fail = e.fail || a.fail),
            "success" === t ? a.done : a.fail);
        n
          .addClass("success" === t ? i : s)
          .find(o)
          .html(e),
          setTimeout(function () {
            n
    ...
    (p.Toast = function (e, t, n) {
      ...
      (n.position = n.position ? "toast-" + n.position : "toast-bottom-right"),
        ...
        "" !==
          (e =
            "" !== e ? o + '<div class="toastr-text">' + e + "</div>" : "") &&
    ...
    (p.TGL.content = function (e, t) {
      var e = x(e || ".toggle"),
        n = x("[data-content]"),
        i = !1,
        a = { active: "active", content: "content-active", break: !0 },
        s = t ? u(a, t) : a;
      p.TGL.screen(n),
        e.on("click", function (e) {
          (i = this),
            p.Toggle.trigger(x(this).data("target"), s),
            e.preventDefault();
        }),
        c.on("mouseup", function (e) {
          ...
          i &&
            ...
            t.is(e.target) ||
              ...
              (p.Toggle.removed(t.data("target"), s), (i = !1)));
        }),
        r.on("resize", function () {
          n.each(function () {
            var e = x(this).data("content"),
              ...
              t = d[t];
            p.Win.width > t && p.Toggle.removed(e, s);
          });
        });
    }),
    ...
    (p.TGL.ddmenu = function (e, t) {
      var e = e || ".nk-menu-toggle",
        ...
        a = t ? u(n, t) : n;
      x(e).on("click", function (e) {
        (p.Win.width < d.lg || x(this).parents().hasClass(l)) &&
          p.Toggle.dropMenu(x(this), a),
          e.preventDefault();
      });
    }),
      ...
      n.on("click", function (e) {
        ...
        c.on("mouseup", function (e) {
          !n.is(e.target) &&
            ...
            0 === a.has(e.target).length &&
            p.Win.width < o &&
            p.Toggle.removed(n.data("target"), i);
        }),
        r.on("resize", function () {
          (p.Win.width < d.xl || p.Win.width < o) &&
            p.Toggle.removed(n.data("target"), i);
        });
    }),
    ...
    (p.Dropzone = function (a, o) {
      x(a).exists() &&
        x(a).each(function (e) {
          var t = (t = x(a)[e].dataset.maxFiles) ? Number(t) : null,
            n = (n = x(a)[e].dataset.maxFileSize) ? Number(n) : 256,
            e = x(a)[e].dataset.acceptedFiles,
            t = {
              autoDiscover: !1,
              maxFiles: t,
              maxFilesize: n,
              acceptedFiles: e || null,
            },
            n = o ? u(t, o) : t;
          x(this).addClass("dropzone").dropzone(n);
        });
    }),
    (p.Dropzone.init = function () {
      p.Dropzone(".upload-zone", { url: "/images" });
    }),
    (p.Wizard = function () {
      var e = x(".nk-wizard");
      e.exists() &&
      ...
      x(e).exists() &&
        x(e).each(function () {
          var e = x(this).data("auto-responsive"),
            ...
            n = x(this).data("export-title")
              ? x(this).data("export-title")
              : "Export",
            a = t
            ...
            t = i ? u(a, i) : a,
            t = !1 === e ? u(t, { responsive: !1, autoWidth: !1 }) : t;
          x(this).DataTable(t), x(".dt-export-title").text(n);
        });
    }),
    (p.DataTable.init = function () {
      p.DataTable(".datatable-init", { responsive: { details: !0 } }),
      ...
      x(e || ".dropdown-menu").on("click", function (e) {
        ...
        p.State.isRTL &&
          x(".dropdown-menu").each(function () {
            var e = x(this);
            e.hasClass("dropdown-menu-end") &&
            !e.hasClass("dropdown-menu-center")
              ? e
                  .prev('[data-bs-toggle="dropdown"]')
    ...
    (p.BS.tabfix = function (e) {
      x(e || '[data-toggle="modal"]').on("click", function () {
        ...
        e && "#" !== e && t
          ? t.find('[href="' + e + '"]').tab("show")
          : t &&
            ((n = t.find(".nk-nav.nav-tabs")),
            (e = x(n[0]).find('[data-bs-toggle="tab"]')),
            x(e[0]).tab("show"));
      });
    }),
        ...
        a[t].addEventListener("click", function () {
          ...
          s.forEach(function (e, t, n) {
            ...
            s[t].classList.contains("number-spinner") &&
              ((a = "" == !s[t].value ? parseInt(s[t].value) : 0),
              (o = "" == !s[t].step ? parseInt(s[t].step) : 1),
              (i = "" == !s[t].max ? parseInt(s[t].max) : 1 / 0),
              (s[t].value = a + o < i + 1 ? a + o : a));
          });
        });
      }),
          ...
          o[t].addEventListener("click", function () {
            ...
            s.forEach(function (e, t, n) {
              ...
              s[t].classList.contains("number-spinner") &&
                ((a = "" == !s[t].value ? parseInt(s[t].value) : 0),
                (o = "" == !s[t].step ? parseInt(s[t].step) : 1),
                (i = "" == !s[t].min ? parseInt(s[t].min) : 0),
                (s[t].value = i - 1 < a - o ? a - o : a));
            });
          });
        });
    }),
    (p.Custom.Stepper = function (n, e) {
      var t =
          !(!n.dataset.stepInit || isNaN(n.dataset.stepInit)) &&
          parseInt(n.dataset.stepInit),
        t = {
          selectors: {
        ...
        i =
          (n.querySelector(".".concat(t.selectors.progress)),
          n.querySelector(".".concat(t.selectors.progress, "-count"))),
      ...
      function y(e) {
        ...
        1 === t &&
          ...
          n.setAttribute("data-step-current", "first")),
          (h !== t) & (1 !== t) &&
            ((r.style.display = "block"),
            (c.style.display = "block"),
            (l.style.display = "none"),
            n.setAttribute("data-step-current", t)),
          h === t &&
            ((r.style.display = "block"),
            (l.style.display = "block"),
            (c.style.display = "none"),
            n.setAttribute("data-step-current", "last")),
          b &&
            ((i.innerHTML = "".concat(e, " of ").concat(h)),
            (s.style.width = "".concat((100 / h) * e, "%")));
      }
      m !== h && v
        ? console.error(
      ...
      r.querySelector("button").addEventListener("click", function (e) {
        ...
        var e = k.form(),
          t = g - 1;
        e
          ? h !== g && (v && a[t].classList.add(p), o[t].classList.add(f))
          : (v && a[t].classList.remove(p), o[t].classList.remove(f)),
          y(--g);
      }),
    ...
    (p.Tagify = function (e, t) {
      x(e).exists() &&
        "function" == typeof x.fn.tagify &&
        ((t = t ? u(void 0, t) : void 0), x(e).tagify(t));
    }),
    ...
    (p.TGL.init = function () {
      p.TGL.content(".toggle"),
        ...
        p.TGL.expand(".toggle-opt", { toggle: !1 }),
        p.TGL.showmenu(".nk-nav-toggle"),
        p.TGL.ddmenu("." + e + "-toggle", {
          self: e + "-toggle",
          child: e + "-sub",
        });
    }),
